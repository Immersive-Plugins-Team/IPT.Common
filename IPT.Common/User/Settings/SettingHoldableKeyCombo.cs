...
{
    /// <summary>
    /// A holdable key combination for the INI settings.
    /// </summary>
    public class SettingHoldableKeyCombo : Setting
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingHoldableKeyCombo"/> class.
        /// </summary>
        ...
        public SettingHoldableKeyCombo(string section, string name, string description)
                   : base(section, name, description)
        {
            this.Value = new HoldableKeyCombo(Keys.None, Keys.None);
        }

        /// <summary>
        /// Gets the value of the setting.
        /// </summary>
        public HoldableKeyCombo Value { get; private set; }
        ...
        {
            this.Value = (HoldableKeyCombo)value;
        }
        ...
        public override void Load(InitializationFile ini)
        {
            ...
            this.Value = new HoldableKeyCombo(primary, secondary);
        }
